...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.select_player_label = QtWidgets.QLabel(Dialog)
        font = QtGui.QFont()
        ...
        self.selected_player_info_label = QtWidgets.QLabel(Dialog)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.verticalLayout_2.addWidget(self.players_list_widget)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.select_player_label.setText(_translate("Dialog", "Run Android Emulator with MFF installed and select emulator\'s window from the list below"))
