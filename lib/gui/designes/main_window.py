...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.low_memory_mode_label = QtWidgets.QLabel(self.settings_group)
        self.low_memory_mode_label.setToolTipDuration(-1)
        self.low_memory_mode_label.setObjectName("low_memory_mode_label")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.low_memory_mode_label)
        self.low_memory_mode_checkbox = QtWidgets.QCheckBox(self.settings_group)
        self.low_memory_mode_checkbox.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.low_memory_mode_checkbox.setText("")
        self.low_memory_mode_checkbox.setObjectName("low_memory_mode_checkbox")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.low_memory_mode_checkbox)
...
"color: rgb(0, 0, 127);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.low_memory_mode_label.setToolTip(_translate("MainWindow", "Consume less RAM memory by creating less Tesseract APIs"))
        self.low_memory_mode_label.setText(_translate("MainWindow", "Low RAM mode"))
        self.low_memory_mode_checkbox.setToolTip(_translate("MainWindow", "Consume less RAM memory by creating less Tesseract APIs"))
