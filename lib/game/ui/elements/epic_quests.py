...
EQ_FATE_OF_MANKIND.text_rect = Rect(0.024366459164933994, 0.7807074368928463, 0.19288216647410045, 0.8199210380307054)
EQ_FATE_OF_MANKIND.button_rect = Rect(0.07802721177449304, 0.2531094625644267, 0.27168590722438596, 0.7223434016038928)
...
EQ_DARK_REIGN.text_rect = Rect(0.33374641580485354, 0.7808314846569708, 0.42496788624843246, 0.8193804484874085)
EQ_DARK_REIGN.button_rect = Rect(0.38085258496834107, 0.25310946256442673, 0.5580615070595558, 0.6984164585367247)
...
EQ_GALACTIC_IMPERATIVE.text_rect = Rect(0.6425535247654938, 0.779502210042128, 0.8384553711279336, 0.8233682723319365)
EQ_GALACTIC_IMPERATIVE.button_rect = Rect(0.67545307148285, 0.2251946956527304, 0.8900478421165151, 0.7103799300703088)
...
EQ_FIRST_FAMILY.text_rect = Rect(0.9524788620313259, 0.7798231626548704, 0.9993362825389835, 0.818965104283757)
EQ_FIRST_FAMILY.button_rect = Rect(0.9648989012020304, 0.23183597985045878, 0.9936908101886635, 0.6995320003392056)
EQ_FIRST_FAMILY.text = "FIRST"
...
EQ_HEROES_REUNITED_STAGE = UIElement(name='EQ_HEROES_REUNITED_STAGE')
EQ_HEROES_REUNITED_STAGE.description = "Epic Quest: The Fate of Mankind: Heroes Reunited: Madness Ensues stage button and text."
EQ_HEROES_REUNITED_STAGE.text_rect = Rect(0.04737081596968373, 0.015169306507586995, 0.20588681378967333, 0.07631593879035016)
EQ_HEROES_REUNITED_STAGE.button_rect = Rect(0.44964254628644973, 0.36476853021121175, 0.5565660731178579, 0.6106843339571078)
EQ_HEROES_REUNITED_STAGE.text = "HEROES REUNITED"
EQ_HEROES_REUNITED_STAGE.text_threshold = 120
...
EQ_RECLAIMED_MEMORY = UIElement(name='EQ_RECLAIMED_MEMORY')
EQ_RECLAIMED_MEMORY.description = "Epic Quest: The Fate of Mankind: Reclaimed Memory mission."
EQ_RECLAIMED_MEMORY.text_rect = Rect(0.3772066037512226, 0.8696007682054352, 0.4932647930825934, 0.8991657270052965)
EQ_RECLAIMED_MEMORY.button_rect = Rect(0.41612855749040184, 0.7312115993550201, 0.45593510108728974, 0.808583725575934)
EQ_RECLAIMED_MEMORY.text = "RECLAIMED MEMORY"
EQ_RECLAIMED_MEMORY.text_threshold = 120

EQ_RECLAIMED_MEMORY_LABEL = UIElement(name='EQ_RECLAIMED_MEMORY_LABEL')
EQ_RECLAIMED_MEMORY_LABEL.description = "Epic Quest: The Fate of Mankind: Reclaimed Memory label."
EQ_RECLAIMED_MEMORY_LABEL.text_rect = Rect(0.04811853294053273, 0.017827855737272313, 0.22757060594429449, 0.07365738956066484)
EQ_RECLAIMED_MEMORY_LABEL.text = "RECLAIMED MEMORY"
EQ_RECLAIMED_MEMORY_LABEL.text_threshold = 120

EQ_INDUSTRIAL_COMPLEX = UIElement(name='EQ_INDUSTRIAL_COMPLEX')
EQ_INDUSTRIAL_COMPLEX.description = "Epic Quest: The Fate of Mankind: Reclaimed Memory: Industrial Complex mission."
EQ_INDUSTRIAL_COMPLEX.text_rect = Rect(0.34197130248419266, 0.6625260439359723, 0.47057862147022195, 0.7130384792999941)
EQ_INDUSTRIAL_COMPLEX.button_rect = Rect(0.3515625, 0.30833333333333335, 0.4640625, 0.6157407407407407)
EQ_INDUSTRIAL_COMPLEX.text = "Industrial Complex"
EQ_INDUSTRIAL_COMPLEX.text_threshold = 120

EQ_DEVIANT_DIVERSION = UIElement(name='EQ_DEVIANT_DIVERSION')
EQ_DEVIANT_DIVERSION.description = "Epic Quest: The Fate of Mankind: Reclaimed Memory: Deviant Diversion mission."
EQ_DEVIANT_DIVERSION.text_rect = Rect(0.5348822809632364, 0.6625260439359723, 0.6537692793282287, 0.7130384792999941)
EQ_DEVIANT_DIVERSION.button_rect = Rect(0.5401041666666667, 0.30092592592592593, 0.653125, 0.6092592592592593)
EQ_DEVIANT_DIVERSION.text = "Deviant Diversion"
EQ_DEVIANT_DIVERSION.text_threshold = 120
