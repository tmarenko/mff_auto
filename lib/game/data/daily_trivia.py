trivia_qa = {
    ...
    "Where can you craft rank up materials, materials, and consumable items?": "Craft",
    "What is the name of the shop you can use Support Tokens acquired in Dimension Mission to purchase rewards?": "Support Shop"
}
